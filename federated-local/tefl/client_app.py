"""TE Federated Learning with Local Loss: Client Application."""
...
def _get_backbone_keys(state_dict: dict) -> list:
    return [k for k in state_dict.keys() if k.startswith('backbone.')]
